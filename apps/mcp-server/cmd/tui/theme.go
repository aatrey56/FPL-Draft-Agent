...
var (
	...
	freeC   = lipgloss.AdaptiveColor{Light: "#2E7BB5", Dark: "#8FD6FF"} // free agents on leaderboards
...
var (
	...
	styYellow = lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Light: "#8A7A00", Dark: "#F1FA8C"})
